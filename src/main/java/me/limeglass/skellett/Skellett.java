...
import me.limeglass.skellett.elements.Register;
...
public class Skellett extends JavaPlugin {
	...
	private String packageName = "me.limeglass.skellett";
	private static String prefix = "&8[&aSkellett&8] &e";
	private String nameplate = "[Skellett] ";
	...
	public void onEnable() {
		...
		if (!SkellettUpdater.validate()) this.setEnabled(false);
		Register.register();
